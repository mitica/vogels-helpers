...
exports.getItemByKey = function(model, key, options) {
	options = options || {};
	return models.model(model).getAsync(key, options.params)
...
exports.getItemByRangeKey = function(model, key, rangeKey, options) {
	options = options || {};
	return models.model(model).getAsync(key, rangeKey, options.params)
		.then(utils.formatResult.bind(null, options.format));
};
...
exports.getItems = function(model, keys, options) {
	options = options || {};
	return models.model(model).getItemsAsync(keys, options.params)
		.then(utils.formatResult.bind(null, options.format));
};
